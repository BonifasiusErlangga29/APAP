...
public class CustomUserBean implements UserDetails {
  ...
  CustomUserBean(String id, String userName, String email, 
  ...
  public static CustomUserBean createInstance(UserModel user) {
    List<GrantedAuthority> authorities = new ArrayList<>();

    authorities.add(new SimpleGrantedAuthority(user.getRole()));
    return new CustomUserBean(user.getUuid(), user.getUsername(), user.getEmail(), user.getPassword(), authorities);
  }
  @Override
